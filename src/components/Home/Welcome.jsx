  ...
  return (
    <>
      <div data-aos="zoom-in" id="about">
        <div className="text-center md:px-8 lg:px-32 lg:pt-40 sm:px-0 sm:pt-2  text-gray-950 text-3xl md:text-5xl font-semibold">
        ...
        <div className="flex flex-col mt-10 items-center justify-center lg:text-center text-justify">
          <p className="w-[60%]   text-gray-600 lg:px-6 px-2 py-6 text-base   font-sm  ">
