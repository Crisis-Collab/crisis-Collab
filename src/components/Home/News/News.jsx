      ...
      <div className='h-72'>
        ...
        >
          ...
          <SwiperSlide>
            ...
            <div className="text-base sm:w-1/2 sm:h-3 " data-swiper-parallax="-100">
              <p>
            ...
            <img src={img4} alt="Your Image" className=" p-6 relative rounded-2xl ml-[30rem] bottom-[7rem] left-[22rem] h-56" />
