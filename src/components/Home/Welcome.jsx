  ...
  return (
    <>
      <div data-aos="zoom-in">
        <div className="text-center  md:px-8 lg:px-32 pt-12 text-gray-950 text-3xl md:text-5xl font-semibold">
        ...
        <div className="flex flex-col items-center md:flex-row">
          <p className="md:flex-grow text-gray-600 px-6 py-6 text-base md:text-xl font-sm  md:text-left">
