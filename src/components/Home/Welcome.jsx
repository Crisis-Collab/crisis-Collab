  ...
  return (
    <>
      <div data-aos="zoom-in" id="about">
        <div className="text-center  j  md:px-8 lg:px-32 lg:pt-40  text-gray-950 text-3xl md:text-5xl font-semibold">
        ...
        <div className="flex flex-col mt-10 items-center justify-center lg:text-center text-justify">
          <p className="lg:w-[60%] px-3  text-gray-600 lg:px-6 py-6 text-base  font-sm  ">
