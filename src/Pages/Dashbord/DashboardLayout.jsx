    ...
    <>
      ...
      <div className='flex w-screen h-auto'>
        ...
        <div className={`     ${isOpen ? 'w-5/6  ml-[248px] ' : 'w-11/12  ml-[120px] '} `}>
          ...
          <div className={`flex flex-col flex-1 overflow-y-auto mt-16 h-[680px] p-2 bg-zinc-800  shadow-2xl  w-auto  transition-all }`} >
            <div className=' p-4   '>
              <Outlet />
            </div>
      ...
      <div className={`flex flex-col flex-1 overflow-y-auto mt-16 p-2 bg-white  shadow-2xl rounded-2xl w-auto m-4 transition-all ${isOpen ? 'ml-[296px]' : 'ml-36'
        }`} >
        <div className=' p-2   '>
          <Outlet />
        </div>
