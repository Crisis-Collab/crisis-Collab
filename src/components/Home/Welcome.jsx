  ...
  return (
    <>
      <div
        data-aos="zoom-in"
        id="about"
        className="text-center md:px-8 lg:px-32 pt-2 sm:pt-32 text-gray-950 text-3xl md:text-5xl font-semibold"
      >
      ...
      <div className="flex flex-col mt-10 items-center justify-center text-center">
        <p className="w-full sm:w-3/4 md:w-[60%] text-gray-600 px-6 py-6 text-base font-sm">
          ...
          under one unified banner. Our mission is clear: to amplify the impact
          of humanitarian efforts by fostering collaboration, sharing resources,
          and delivering rapid relief to those in need
        </p>
